...
// Giveaway registration popup — matches the dark popup family in FloatingActions.
// Auto-fills email from logged-in user. Generates a unique ticket number on register.
// Writes to the `giveaway` Supabase table.
//
// Props:
