...
desc: 'You are only responsible for yourself. We make no promises, no instructions, no claims to save or cure anyone. The journey of change and healing is your own. We simply provide a safe space and energy for you to connect, experience, and move forward on your journey, if you wish. We have our own approach and process to healing—it is not easy, but for those who are ready for it, it can be a meaningful and profound journey.',    btn_book:        'Book Consultation →',
...
desc: 'तपाईं केवल आफ्नो लागि जिम्मेवार हुनुहुन्छ। हामी कसैलाई बचाउन वा निको पार्न कुनै वाचा गर्दैनौं, कुनै निर्देशन दिँदैनौं, कुनै दाबी गर्दैनौं। परिवर्तन र उपचारको यात्रा तपाईंको आफ्नै हो। यदि तपाईं चाहनुहुन्छ भने, हामी तपाईंलाई जडान गर्न, अनुभव गर्न र तपाईंको यात्रामा अगाडि बढ्नको लागि सुरक्षित ठाउँ र ऊर्जा प्रदान गर्दछौं। उपचारको लागि हाम्रो आफ्नै दृष्टिकोण र प्रक्रिया छ - यो सजिलो छैन, तर यसको लागि तयार हुनेहरूका लागि, यो अर्थपूर्ण र गहिरो यात्रा हुन सक्छ।', btn_book: 'पुस्तक परामर्श →',    btn_book:        ' परामर्श बुक गर्नुहोस् →',
...
const OFFICE = {
  ...
  embedUrl: 'https://www.google.com/maps/embed/v1/search?key=YOUR_GOOGLE_MAPS_API_KEY&q=Common+Psychology+Thimi+Bhaktapur+Nepal',
  gmapsUrl: 'https://www.google.com/maps/search/?api=1&query=Common+Psychology+Thimi+Bhaktapur+Nepal',
}
