    ...
    <div className="page-wrapper">
      ...
      <div style={{ background:'var(--white)', padding:'0.75rem 1rem', borderBottom:'1px solid var(--earth-cream)', position:'sticky', top:0, zIndex:10 }}>
        <div style={{ display:'flex', gap:'0.5rem', alignItems:'center', marginBottom:'0.6rem' }}>
          ...
          <button onClick={() => navigate('/return-refund')}
            style={{ flexShrink:0, display:'flex', alignItems:'center', gap:4, padding:'0.45rem 0.85rem', background:'rgba(29,158,117,0.08)', color:'var(--green-deep)', border:'1.5px solid rgba(29,158,117,0.25)', borderRadius:8, fontSize:'0.78rem', fontWeight:700, cursor:'pointer', whiteSpace:'nowrap' }}>
            ↩ Returns
          </button>
