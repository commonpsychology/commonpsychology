...
{/* ── Left panel ── */}
      ...
      <div className="reg-right">
        <div className="reg-card">
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '1.75rem', color: 'var(--green-deep)', marginBottom: '0.1rem', textAlign: 'center' }}>
            Create your account
          </h1>
          <p style={{ color: 'var(--text-light)', fontSize: '0.88rem', marginBottom: '1.75rem', fontFamily: 'var(--font-body)', textAlign: 'center' }}>
