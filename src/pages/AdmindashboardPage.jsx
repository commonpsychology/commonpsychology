...
/* .adm-content is the single shared wrapper every tab renders into
   ({tab === 'x' && (...)} all sit inside it) — styling it here gives
   EVERY tab the same frosted glass gradient panel treatment the
   Courses tab has, with zero changes needed to individual tab JSX. */
.adm-content {
  ...
  background:
    linear-gradient(160deg, rgba(255,255,255,.55) 0%, rgba(219,234,254,.35) 55%, rgba(191,219,254,.3) 100%);
  backdrop-filter: var(--glass-blur); -webkit-backdrop-filter: var(--glass-blur);
