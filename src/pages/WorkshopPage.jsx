...
function CountdownPill({ dateStr }) {
  ...
  if (diff.past) return (
    <span style={{
      ...
      background: '#fff0e8', border: '1px solid #f5c4a4',
      borderRadius: 100, padding: '0.2rem 0.65rem',
      fontSize: '0.65rem', fontWeight: 800, color: '#c05a1a',
    }}>
      📅 Workshop passed
    </span>
  )
  const label  = diff.days > 0
    ? diff.days + 'd ' + diff.hours + 'h away'
    : diff.hours > 0
      ? diff.hours + 'h ' + diff.mins + 'm away'
      : diff.mins + 'm away'
  const urgent = diff.days < 3
  return (
    <span style={{
      display: 'inline-flex', alignItems: 'center', gap: 4,
      background: urgent ? '#fff0e8' : C.skyFainter,
      border: '1px solid ' + (urgent ? '#f5c4a4' : C.borderFaint),
      borderRadius: 100, padding: '0.2rem 0.65rem',
      fontSize: '0.65rem', fontWeight: 800,
      color: urgent ? '#c05a1a' : C.skyDeep,
    }}>
      {urgent ? '⏰' : '🗓'} {label}
    </span>
  )
...
function EnrollmentCard({ reg, isOpen, chip, onToggle }) {
  ...
  return (
    <div style={{
      background: isOpen ? C.skyFainter : C.white,
      border: '1.5px solid ' + (isOpen ? C.skyMid : C.borderFaint),
      borderRadius: 16, overflow: 'hidden',
      boxShadow: isOpen ? '0 4px 24px rgba(0,191,255,0.1)' : '0 1px 4px rgba(0,80,130,0.06)',
      ...
      <div
        ...
        style={{
          ...
          padding: '1rem 1.1rem', cursor: 'pointer', flexWrap: 'wrap',
        }}
      >
        <div style={{
          width: 46, height: 46, borderRadius: 12, flexShrink: 0,
          background: isOpen ? heroGrad : sectionGrad,
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontSize: '1.4rem',
          boxShadow: isOpen ? '0 4px 14px rgba(0,191,255,0.25)' : 'none',
          transition: 'all 0.22s',
        }}>
          {ws.emoji || '📅'}
        </div>
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{
            ...
            <span style={{
              ...
              color: C.textDark, fontSize: '0.92rem',
            }}>
              {ws.title || 'Workshop'}
            </span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexShrink: 0 }}>
          {ws.mode && (
            <span style={{
              ...
              color: C.skyDeep, background: C.skyFaint,
          ...
          <span style={{
            color: C.textLight, fontSize: '0.75rem',
        ...
        <div style={{ borderTop: '1px solid ' + C.borderFaint }}>
          <div style={{
            ...
            {[
              ...
              <div key={label} style={{
                ...
                <div style={{
                  fontFamily: 'var(--font-body)', fontSize: '0.62rem', fontWeight: 800,
                  color: C.textLight, textTransform: 'uppercase',
                  letterSpacing: '0.07em', marginBottom: '0.25rem',
                }}>{label}</div>
                <div style={{
                  fontFamily: 'var(--font-body)', fontSize: '0.82rem',
                  fontWeight: 600, color: C.textDark,
                }}>{val}</div>
              </div>
            ))}
          </div>
          ...
          {reg.notes && (
            <div style={{
              ...
              fontFamily: 'var(--font-body)', fontSize: '0.8rem', color: '#78350f',
            }}>
              📝 <em>{reg.notes}</em>
            </div>
          )}
          ...
          {reg.status !== 'cancelled' && ws.date && (
            <div style={{
              ...
              background: heroGrad, borderRadius: 12, padding: '0.75rem 1rem',
            }}>
              <div>
                <div style={{
                ...
                }}>Save your spot: {ws.date} at {ws.time}</div>
              </div>
              <a
                href={googleCalLink(ws)}
                target="_blank"
  ...
  return (
    <div id="my-enrollments-section" style={{ background: 'var(--white)', padding: '0 0 4rem' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 clamp(1rem,4vw,2rem)' }}>
        ...
        {/* Header card */}
        <div style={{
          background: 'linear-gradient(135deg, #0f2942 0%, #1a4060 50%, #0e3a5a 100%)',
          borderRadius: 20, overflow: 'hidden', position: 'relative',
          boxShadow: '0 12px 48px rgba(0,80,130,0.22)', marginBottom: '2.5rem',
        }}>
          <div style={{
          ...
          <div style={{
            ...
            background: 'rgba(0,191,255,0.05)', pointerEvents: 'none',
          }} />
          <div style={{ position: 'relative', padding: 'clamp(1.5rem,4vw,2.5rem)' }}>
            <div style={{
              ...
              <div style={{
                width: 52, height: 52, borderRadius: 14, background: btnGrad,
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '1.5rem', flexShrink: 0,
                boxShadow: '0 4px 16px rgba(0,191,255,0.35)',
              }}>
                🎟️
              </div>
              <div style={{ flex: 1, minWidth: 200 }}>
                <h2 style={{
                  ...
                  fontSize: 'clamp(1.1rem,3vw,1.5rem)', margin: '0 0 0.3rem',
                }}>
                ...
                <p style={{
                  ...
                  {userEmail
                    ? 'Showing registrations for your account.'
                    : 'Enter the email you registered with to see all your workshops.'}
                </p>
              </div>
            </div>
            ...
            {!userEmail && (
              <form onSubmit={lookup} style={{
                marginTop: '1.5rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap',
              }}>
                <input
                  type="email"
                  ...
                  style={{
                    flex: 1, minWidth: 220, padding: '0.78rem 1.1rem',
                ...
                <button
                  ...
                  disabled={loading}
                  style={{
                    padding: '0.78rem 1.5rem', borderRadius: 12, border: 'none',
                    background: loading ? 'rgba(0,191,255,0.3)' : btnGrad,
                    color: '#fff', fontFamily: 'var(--font-body)',
                    fontWeight: 700, fontSize: '0.88rem',
                    cursor: loading ? 'not-allowed' : 'pointer',
                    whiteSpace: 'nowrap',
                    boxShadow: loading ? 'none' : '0 4px 18px rgba(0,191,255,0.4)',
                  }}
                >
            ...
            {userEmail && (
              <div style={{
                ...
                <button
                  onClick={() => fetchByEmail(userEmail)}
                  disabled={loading}
                  style={{
          ...
          <>
            {enrollments.length === 0 ? (
              <div style={{
                ...
                No registrations found for <strong>{fetchedFor}</strong>.
                Double-check the email you signed up with.
              </div>
            ) : (
              <>
                {active.length > 0 && (
                  <div style={{ marginBottom: '2rem' }}>
                    <div style={{
                      ...
                      <span>✅</span>
                      <h3 style={{
                        fontFamily: 'var(--font-display)', color: C.textDark,
...
function FInput({ label, required, type = 'text', placeholder, value, onChange }) {
  ...
  return (
    <div>
      <label style={{
        display: 'block', fontFamily: 'var(--font-body)', fontSize: '0.66rem',
        fontWeight: 800, color: C.textLight, textTransform: 'uppercase',
        letterSpacing: '0.09em', marginBottom: '0.4rem',
      }}>
      ...
      <input
        ...
        style={{
          ...
          background: f ? C.skyGhost : C.white,
          outline: 'none', boxSizing: 'border-box',
    ...
    >
      ...
      <div style={{ padding: '1.4rem' }}>
        ...
        <h3 style={{
          ...
          color: 'var(--blue-deep)', marginBottom: '0.4rem', lineHeight: 1.3,
        }}>
          {ws.title}
        </h3>
        <p style={{
        ...
        <div style={{
          fontFamily: 'var(--font-body)', fontSize: '0.78rem',
          color: 'var(--text-mid)', marginBottom: '0.6rem',
        }}>
          📅 {ws.date} · {ws.time}
        </div>
        ...
        <div style={{ marginBottom: '1rem' }}>
          <div style={{
            display: 'flex', justifyContent: 'space-between',
            fontFamily: 'var(--font-body)', fontSize: '0.7rem',
            color: urgent ? '#e53e3e' : 'var(--text-light)',
            marginBottom: '0.3rem', fontWeight: urgent ? 700 : 400,
          }}>
            <span>
              {full ? '🔴 Workshop Full' : urgent ? '⚠ Almost full!' : '🟢 Seats available'}
            </span>
            <span>{left} of {ws.seats} left</span>
          </div>
          <div style={{
            height: 5, background: 'var(--earth-cream)',
            ...
            <div style={{
              ...
              background: p >= 100
                ? '#e53e3e'
                : p >= 90
                  ? 'linear-gradient(90deg,#e53e3e,#f97316)'
                  : p >= 70
                    ? 'linear-gradient(90deg,#f97316,#ffd54f)'
                    : btnGrad,
        ...
        {isReg ? (
          ...
          <button
            ...
            style={{
              ...
              background: 'var(--earth-cream)', color: 'var(--text-light)',
    ...
    try {
      ...
      try {
        await fetch(API_BASE + '/workshops/registration/' + registrationId + '/payment', {
          ...
          body: JSON.stringify({
            payment_status: 'paid',
            payment_ref:    result.transactionId || result.paymentId || 'confirmed',
          }),
        })
      } catch (patchErr) {
    ...
    <div className="page-wrapper" style={{ background: C.skyGhost }}>
      <div style={{ maxWidth: 520, margin: '0 auto', padding: '5rem 2rem' }}>
        <div style={{
          ...
          boxShadow: '0 8px 40px rgba(0,191,255,0.12)', overflow: 'hidden',
        }}>
          ...
          <div style={{ padding: '3rem 2.5rem', textAlign: 'center' }}>
            ...
            {/* Success icon */}
            <div style={{
              width: 76, height: 76, borderRadius: '50%', background: heroGrad,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            ...
            <div style={{
              display: 'inline-block', background: sectionGrad,
              border: '1px solid ' + C.borderFaint, borderRadius: 100,
              padding: '0.28rem 1rem', marginBottom: '0.9rem',
            }}>
              <span style={{
                fontFamily: 'var(--font-body)', fontSize: '0.65rem', fontWeight: 800,
                color: C.skyDeep, letterSpacing: '0.1em', textTransform: 'uppercase',
              }}>
            ...
            <h2 style={{
              ...
              color: C.textDark, marginBottom: '0.75rem',
            }}>
            ...
            <p style={{
              fontFamily: 'var(--font-body)', fontSize: '0.9rem',
              color: C.textMid, lineHeight: 1.78, marginBottom: '1.25rem',
            }}>
              {isFree(workshop)
            ...
            <div style={{
              ...
              <p style={{
                fontFamily: 'var(--font-body)', fontSize: '0.78rem',
                color: '#78350f', lineHeight: 1.65, margin: 0,
              }}>
                <strong style={{ display: 'block', marginBottom: '0.2rem', color: '#92400e' }}>
                  Note: Enrollment Verification
                </strong>
                After successful enrollment verification by our admin, you will be sent a message
                from the <strong>Common Psychology verified account</strong> with the confirmed date,
                time, location, and all further details of your workshop or training.
              </p>
            </div>

            {/* ── COD not accepted notice ── */}
            {!isFree(workshop) && (
              <div style={{
                background: '#fff0f0', border: '1px solid #fca5a5', borderRadius: 12,
                padding: '0.75rem 1.1rem', marginBottom: '0.85rem',
                textAlign: 'left', display: 'flex',
                ...
                <p style={{
                  ...
                  color: '#b91c1c', lineHeight: 1.6, margin: 0,
                }}>
                  <strong>Cash on Delivery (COD) is not accepted</strong> for workshops and
                  trainings. Payments must be made via eSewa, Khalti, FonePay, or Card only.
                </p>
              </div>
            )}

            {/* ── See My Enrollment Status CTA banner ── */}
            <div style={{
              background: 'linear-gradient(135deg, #0f2942 0%, #1a4060 100%)',
              ...
              <div style={{ textAlign: 'left' }}>
                <div style={{
                  ...
                  color: '#fff', fontWeight: 700, marginBottom: '0.2rem',
                }}>
                  🎟️ Track your enrollment
                </div>
                <div style={{
                  fontFamily: 'var(--font-body)', fontSize: '0.7rem',
                  color: 'rgba(255,255,255,0.6)',
                }}>
                  View payment &amp; confirmation status below
                </div>
              </div>
              <button
                onClick={() => {
            ...
            <div style={{
              ...
              {[
                ...
                ['Mode',        workshop?.mode],
                ['Facilitator', workshop?.facilitator],
                ['Seats Left',  seatsLeft(workshop) + ' of ' + workshop?.seats],
              ].map(([k, v]) => (
                <div key={k} style={{
                  display: 'flex', justifyContent: 'space-between',
                  padding: '0.35rem 0', borderBottom: '1px solid ' + C.borderFaint,
                  fontFamily: 'var(--font-body)', fontSize: '0.78rem',
                }}>
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none', background: btnGrad,
              ...
              <button
                onClick={() => { setScreen('list'); fetchWorkshops() }}
                style={{
    ...
    <div className="page-wrapper" style={{ background: C.skyGhost }}>
      <div style={{ background: heroGrad, padding: '4rem 3rem 3rem' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          <div style={{
            ...
            borderRadius: 100, padding: '0.28rem 0.9rem', marginBottom: '0.85rem',
          }}>
            <span style={{
              fontFamily: 'var(--font-body)', fontSize: '0.68rem', fontWeight: 700,
              letterSpacing: '0.1em', color: 'rgba(255,255,255,0.9)', textTransform: 'uppercase',
          ...
          <p style={{
            ...
            {isFree(workshop) ? 'FREE' : 'NPR ' + workshop?.price?.toLocaleString()}
          </p>
          <p style={{
            fontFamily: 'var(--font-body)', fontSize: '0.82rem',
            color: 'rgba(255,255,255,0.7)', marginTop: '0.4rem',
          }}>
          ...
          <button
            ...
            style={{
              ...
              border: '1px solid rgba(255,255,255,0.25)',
              borderRadius: 100, padding: '0.32rem 1rem', cursor: 'pointer',
            }}
          >
            ← Back to Workshops
          </button>
      ...
      <div style={{ maxWidth: 640, margin: '2.5rem auto', padding: '0 2rem 5rem' }}>
        <div style={{
          ...
          border: '1px solid ' + C.borderFaint, overflow: 'hidden',
          boxShadow: '0 4px 24px rgba(0,191,255,0.07)',
        }}>

          {/* Workshop details summary */}
          <div style={{
            padding: '1.1rem 1.5rem', background: sectionGrad,
            borderBottom: '1px solid ' + C.borderFaint,
          }}>
            <span style={{ fontFamily: 'var(--font-display)', fontSize: '0.92rem', color: C.textDark }}>
              Workshop Details
            </span>
          </div>
          <div style={{ padding: '1rem 1.5rem 0.5rem' }}>
            {[
              ...
              ['Time',        workshop?.time],
              ['Mode',        workshop?.mode],
              ['Seats Left',  seatsLeft(workshop) + ' of ' + workshop?.seats + ' remaining'],
              ['Fee',         isFree(workshop) ? 'FREE' : 'NPR ' + workshop?.price?.toLocaleString()],
            ].map(([k, v]) => (
              <div key={k} style={{
                display: 'flex', justifyContent: 'space-between',
                padding: '0.4rem 0', borderBottom: '1px solid ' + C.borderFaint,
                fontFamily: 'var(--font-body)', fontSize: '0.82rem',
              }}>
                <span style={{ color: C.textLight, fontWeight: 700 }}>{k}</span>
          ...
          {/* Your details */}
          <div style={{
            padding: '0.9rem 1.5rem', background: sectionGrad,
            borderBottom: '1px solid ' + C.borderFaint,
            borderTop: '1px solid ' + C.borderFaint, marginTop: '0.5rem',
          }}>
            <span style={{ fontFamily: 'var(--font-display)', fontSize: '0.92rem', color: C.textDark }}>
              Your Details
            </span>
          ...
          <div style={{ padding: '1.25rem 1.5rem', display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
            ...
            />
            <FInput
              label="Phone/WhatsApp" required type="tel"
          ...
          {/* Payment info + COD notice */}
          {!isFree(workshop) && (
            <div style={{ margin: '0 1.5rem 0.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <div style={{
                background: '#e8f8f0', border: '1px solid #a8d8b8',
                borderRadius: 10, padding: '0.75rem 1rem',
                fontSize: '0.8rem', color: '#1a5a3a',
              }}>
                ℹ️ You'll choose your payment method (eSewa, Khalti, FonePay, or Card) on the next screen.
              </div>
              <div style={{
                background: '#fff0f0', border: '1px solid #fca5a5',
                ...
                <p style={{
                  ...
                  <strong>Cash on Delivery (COD) is not accepted</strong> for workshops and trainings.
                </p>
              </div>
            </div>
          )}
          ...
          {/* Actions */}
          <div style={{
            padding: '1.1rem 1.5rem', borderTop: '1px solid ' + C.borderFaint,
            display: 'flex', gap: '0.75rem',
          }}>
            <button
              onClick={() => setScreen('list')}
              disabled={submitting}
              style={{
                padding: '0.75rem 1.2rem', borderRadius: 12,
                border: '1.5px solid ' + C.border,
                background: C.white, color: C.textMid,
                fontFamily: 'var(--font-body)', fontWeight: 600,
            ...
            <button
              onClick={() => {
                ...
                isFree(workshop) ? handleFreeRegister() : handleProceedPay()
              }}
              disabled={!formOK || submitting}
              style={{
                flex: 1, padding: '0.88rem', borderRadius: 12, border: 'none',
                background: formOK && !submitting ? btnGrad : C.borderFaint,
                color: formOK && !submitting ? 'white' : C.textLight,
                fontFamily: 'var(--font-body)', fontWeight: 700, fontSize: '0.92rem',
                cursor: formOK && !submitting ? 'pointer' : 'not-allowed',
                boxShadow: formOK && !submitting ? '0 6px 22px rgba(0,191,255,0.35)' : 'none',
                transition: 'all 0.2s',
              }}
            >
              {submitting
                ...
                : !formOK
                  ...
                  : isFree(workshop)
                    ? '🎓 Register Free →'
                    : '💳 Choose Payment — NPR ' + workshop?.price?.toLocaleString() + ' →'}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="section" style={{ background: 'var(--white)' }}>
        {loading && (
          <div style={{
            ...
            fontFamily: 'var(--font-body)', color: C.textLight,
          }}>
            Loading workshops…
          </div>
        )}
        {error && (
          <div style={{ textAlign: 'center', padding: '4rem' }}>
            <p style={{ color: '#b91c1c', fontFamily: 'var(--font-body)', marginBottom: '1rem' }}>
              ⚠️ {error}
            </p>
            <button
